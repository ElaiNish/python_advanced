...
# root = tk.Tk()
#
# question = tk.Label(root, text="Who's the best character in next.py course?")
# question.pack()
#
# img = Image.open("hapoel.jpg")  # Open image with PIL
# photo = ImageTk.PhotoImage(img)  # Convert the PIL Image object into a PhotoImage object
#
...
#
# gc = GreetingCard()
# bc = BirthdayCard('Dana Ev', 'Eyal Ch', 30)
#
# gc.greeting_msg()
# bc.greeting_msg()
...
#     engine.runAndWait()
#
# speak("first time i'm using a package in next.py course")
...
# List of dots in the second set
second = (
...
# Connect the dots and create the image
connect_dots(first)
connect_dots(second)
